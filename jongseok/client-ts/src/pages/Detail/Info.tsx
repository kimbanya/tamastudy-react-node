...
const Info = (props: Props) => {
  const { loading, study } = useSelector(({ studyState }: IRootState) => studyState);
    ...
    <Wrapper>
      <Content>
        ...
        <InfoBox>
          ...
          {authState.isLoggedIn && !study.participants.includes(authState.user?._id) && (
            <JoinButton>
